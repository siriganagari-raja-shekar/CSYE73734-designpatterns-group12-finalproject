...
public class FileUtil {
    ...
    public static void writeToFile(String filename, ApartmentBuilder apartmentBuilder) {
        try {
            FileWriter fw = new FileWriter(filename, true);
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter out = new PrintWriter(bw);
            out.println(apartmentBuilder.getApartmentId());
            out.println(apartmentBuilder.getApartmentAddress());
            out.println(apartmentBuilder.getApartmentCategory());
            out.println(apartmentBuilder.getApartmentManagement());
            out.println(apartmentBuilder.getApartmentPrice());
            out.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void appendEntryToFile(String fileName, ApartmentBuilder apartmentBuilder) {
        FileWriter fr = null;
        BufferedWriter bw = null;
        try {
            fr = new FileWriter(fileName, true);
            bw = new BufferedWriter(fr);
            bw.append(apartmentBuilder.getApartmentId() + ",");
            bw.append(apartmentBuilder.getApartmentAddress() + ",");
            bw.append(apartmentBuilder.getApartmentCategory() + ",");
            bw.append(apartmentBuilder.getApartmentManagement() + ",");
            bw.append(apartmentBuilder.getApartmentPrice() + "\n");
        } catch (IOException ex) {
